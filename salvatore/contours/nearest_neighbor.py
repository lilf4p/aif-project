...
class NearestNeighbourPointContoursExperiment(Experiment):
    ...
    def __init__(
        ...
        super(NearestNeighbourPointContoursExperiment, self).__init__(
        ...
        self.metric = NearestNeighbourPointMetric(
...
if __name__ == '__main__':
    ...
    experiment = NearestNeighbourPointContoursExperiment(
        image_path, 100, 200, population_size=200, max_generations=200,
        random_seed=10, num_of_points=2000, hof_size=20, device='gpu',
    )
    experiment.setup()
...
__all__ = [
    'NearestNeighbourPointContoursExperiment',
]
