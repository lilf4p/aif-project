...
class TableTargetPointsNNContoursExperiment(Experiment):
    ...
    def __init__(
            ...
            crowding_factor: float = 10.0, num_of_points: int = 10000,
...
def test_table_target_points_nn(
        ...
        save_image_dir: str = None, save_image_gen_step=100,
    ...
    generic_experiment_test(
        ...
        save_image_dir=save_image_dir, save_image_gen_step=save_image_gen_step,
