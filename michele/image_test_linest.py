...
class ImageTest:
    ...
    def __init__(self, imagePath, polygonSize, edgeMode = False):
        """
        ...
        if edgeMode:
            self.refImage = self.getEdge(imagePath)
        else:
    ...
    def getEdge(self,imagePath):
        ...
        color_coverted = cv2.cvtColor(edged, cv2.COLOR_BGR2RGB)
    ...
    def polygonDataToImage(self, polygonData):
        ...
        image = Image.new('RGB', (self.width, self.height),color="white")#TODO
        draw = ImageDraw.Draw(image, 'RGBA')   #color=(255,255,255,0)
        ...
        for poly in polygons:
            ...
            if self.edgeMode:
                ...
                blue = 255
                alpha = 0
                draw.polygon(vertices, (red, green, blue, alpha), outline='black')
            else:
